  ...
  switch (action.type) {
    ...
    case types.UPDATE_STATS_BLOCK:
      return updateObject(state, {
        abilityScores: updateObject(state.abilityScores, action.payload),
      });
    case types.UPDATE_MISC_STATS:
      return updateObject(state, action.payload);
    case types.UPDATE_SAVING_THROWS:
      return updateObject(state, {
        savingThrow: updateObject(state.savingThrow, action.payload),
      });
    case types.UPDATE_SKILLS:
      return updateObject(state, {
        skills: updateObject(state.skills, action.payload),
      });
